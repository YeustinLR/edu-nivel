...
export function EditFormActions({ closeHref, onCancel, isPending, submitDisabled, submitForReview = false, submitLabel }: { closeHref?: string; onCancel?: () => void; isPending: boolean; submitDisabled?: boolean; submitForReview?: boolean; submitLabel?: string }) {
  return <ContentFormActions closeHref={closeHref} onCancel={onCancel} isPending={isPending} submitDisabled={submitDisabled} submitLabel={submitLabel ?? (submitForReview ? "Guardar y enviar a revisión" : "Guardar cambios")} />;
}
